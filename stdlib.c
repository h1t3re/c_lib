...
char *get_data_by_key_until_end(const char *restrict buffer, char *key, char *end)
{
        ...
        int begining = 0;
        int ending = 0;
        while((buffer[len] != '\0') & (buffer[len] != EOF))
        {
                while((i < strlen(key)) & (buffer[len+i] != '\0'))
                {
                        cmp[i] = buffer[len+i];
                        i = i +1;
                }
...
char *get_data_by_key_until_end_v0(const char *restrict buffer, char *key, char *end)
{
        char *cmp = (char *)malloc(strlen(key)*sizeof(char));
        char *data = (char *)malloc(sizeof(char));
        int len = 0;
        ...
        while(buffer[len] != '\0')
        {
                ...
                while(((begining == 1) & (ending != 1)) & (buffer[len] != '\0'))
                {
                        data[j] = buffer[len];
                        j = j +1;
                        len = len +1;
                        ...
                        i = 0;
                        while((i < strlen(end)) & (buffer[len+i] != '\0'))
                        {
                                cmp[i] = buffer[len+i];
                                i = i +1;
                        }
